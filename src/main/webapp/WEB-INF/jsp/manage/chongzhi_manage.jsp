    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header"><i class="fa fa-table"></i>充值管理</div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="default-datatable" class="table table-bordered">
                                    ...
                                    <tbody>
                                <c:forEach var="order" items="${chongzhiList}" varStatus="index">
                                    <tr>
                                        <td>${order.sellerNick}</td>
                                        <td>${order.sellerRonin}</td>
                                        <td>${order.platformRonin}</td>
                                        <td>${order.chongzhiPrice}</td>
                                        <td style="color: red">
                                        ...
                                        <td>
                                            <button type="button" onclick="void(0);" class="upButton" myAttr="${order.id}">已确认到账，开通服务</button>
                                            <button type="button" onclick="void(0);" class="nopayButton" myAttr="${order.id}">未到账</button>
                                        </td>
                                        </tr>
                                </c:forEach>
                                    </tbody>
